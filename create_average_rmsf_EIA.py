...
# 定义文件路径
repeat1_rmsf_file = "analysis_results_EIA/repeat1_rmsf.xvg"
repeat2_rmsf_file = "analysis_results_EIA/repeat2_rmsf.xvg"
repeat3_rmsf_file = "analysis_results_EIA/repeat3_rmsf.xvg"
template_pdb_file = "analysis_results_EIA/repeat1_rmsf.pdb"
output_pdb_file = "analysis_results_EIA/average_rmsf.pdb"
...
# 保存平均RMSF数据到文件
with open("analysis_results_EIA/average_rmsf.dat", "w") as f:
